...
export const donationContent: {
  ...
  modes: { title: Localized; description: Localized }[];
  configurator: {
    eyebrow: Localized;
    title: Localized;
    frequency: Localized[];
  ...
  impact: { eyebrow: Localized; title: Localized; description: Localized; points: { value: string; label: Localized }[] };
  wishlist: { eyebrow: Localized; title: Localized; description: Localized; items: Localized[] };
  fundraiser: { title: Localized; description: Localized; action: Localized };
  preview: Localized;
  ...
  modes: [
    { title: { en: "Give money", zh: "金錢捐贈" }, description: { en: "Choose a donation that suits you.", zh: "選擇適合你的捐贈方式。" } },
    { title: { en: "Support a programme", zh: "支持計劃" }, description: { en: "Direct your support to an area of activity.", zh: "把支持投向你關心的活動範疇。" } },
    { title: { en: "Donate items", zh: "物資捐贈" }, description: { en: "Explore a future partner wishlist.", zh: "瀏覽未來的合作夥伴心願清單。" } },
  ],
  configurator: {
  ...
  impact: {
    eyebrow: { en: "The Love 21 community", zh: "Love 21 社群" },
  ...
  wishlist: {
    ...
    items: [{ en: "Sports and activity equipment", zh: "體育及活動用品" }, { en: "Healthy cooking supplies", zh: "健康烹飪用品" }, { en: "Art and learning materials", zh: "藝術及學習材料" }],
  },
  fundraiser: {
