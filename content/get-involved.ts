...
const spotHints: Record<string, Localized> = {
  "yoga-04": { en: "8 spots", zh: "8 個名額", cn: "8 个名额" },
  "food-06": { en: "6 spots", zh: "6 個名額", cn: "6 个名额" },
  "family-08": { en: "10 spots", zh: "10 個名額", cn: "10 个名额" },
  "fitness-11": { en: "12 spots", zh: "12 個名額", cn: "12 个名额" },
  "csr-14": { en: "Team of 15", zh: "15 人團隊", cn: "15 人团队" },
  "dance-18": { en: "8 spots", zh: "8 個名額", cn: "8 个名额" },
  "food-18": { en: "6 spots", zh: "6 個名額", cn: "6 个名额" },
  "family-22": { en: "10 spots", zh: "10 個名額", cn: "10 个名额" },
  "sports-27": { en: "12 spots", zh: "12 個名額", cn: "12 个名额" },
};

const recurrenceHints: Record<string, Localized> = {
  "yoga-04": { en: "Weekly", zh: "每週", cn: "每周" },
  "food-06": { en: "Weekly", zh: "每週", cn: "每周" },
  "family-08": { en: "Monthly", zh: "每月", cn: "每月" },
  "fitness-11": { en: "Weekly", zh: "每週", cn: "每周" },
  "csr-14": { en: "By arrangement", zh: "另行安排", cn: "另行安排" },
  "dance-18": { en: "Weekly", zh: "每週", cn: "每周" },
  "food-18": { en: "Weekly", zh: "每週", cn: "每周" },
  "family-22": { en: "Monthly", zh: "每月", cn: "每月" },
  "sports-27": { en: "Weekly", zh: "每週", cn: "每周" },
};

const categoryLabels: Record<OpportunityCategory, Localized> = {
  sports: { en: "Sports", zh: "體育", cn: "体育" },
  nutrition: { en: "Nutrition", zh: "營養", cn: "营养" },
  family: { en: "Family", zh: "家庭", cn: "家庭" },
  events: { en: "Events", zh: "活動", cn: "活动" },
  corporate: { en: "Corporate", zh: "企業", cn: "企业" },
};
...
export const volunteerOpportunities = [
  ...august2026Events.map((event) => ({
    ...
    spots: spotHints[event.id] ?? { en: "Open", zh: "開放", cn: "开放" },
    title: event.title,
    location: event.location,
    time: { en: event.time, zh: event.time, cn: event.time },
    recurrence: recurrenceHints[event.id] ?? { en: "One-off", zh: "一次", cn: "一次" },
  })),
  {
    id: "community-day",
    category: "events" as const,
    categoryLabel: categoryLabels.events,
    spots: { en: "20 spots", zh: "20 個名額", cn: "20 个名额" },
    title: { en: "Community open day helpers", zh: "社區開放日協助", cn: "社区开放日协助" },
    location: { en: "Love 21 Space", zh: "Love 21 Space", cn: "Love 21 Space" },
    time: { en: "Half-day shifts", zh: "半天時段", cn: "半天时段" },
    recurrence: { en: "Seasonal", zh: "季節性", cn: "季节性" },
  },
];
...
export const opportunityFilters: Array<{
  ...
  { id: "all", label: { en: "All", zh: "全部", cn: "全部" } },
...
export const getInvolvedContent = {
  hero: {
    ...
    description: {
      ...
      cn: "参与课堂义工、安排企业日，或协助维持计划免费。每一种参与，都帮助我们的社群运动、学习与连结。",
    } satisfies Localized,
    primary: {
      label: { en: "Volunteer with us", zh: "成為義工", cn: "成为义工" } satisfies Localized,
      href: "#opportunities",
    },
    secondary: {
      label: { en: "Partner your company", zh: "企業合作", cn: "企业合作" } satisfies Localized,
      href: "#corporate",
    },
    helper: {
      en: "↑ pick a date and just show up — no forms, no email tag",
      zh: "↑ 選一個日子直接到來 — 無需表格、無需電郵標籤",
      cn: "↑ 选一个日子直接到来 — 无需表格、无需电邮标签",
    } satisfies Localized,
  },
  ways: {
    volunteer: {
      audience: { en: "For individuals", zh: "個人參與", cn: "个人参与" } satisfies Localized,
      badge: { en: "Most popular", zh: "最受歡迎", cn: "最受欢迎" } satisfies Localized,
      title: { en: "Volunteer with Love 21", zh: "成為 Love 21 義工", cn: "成为 Love 21 义工" } satisfies Localized,
      description: {
        ...
        cn: "加入体育课堂、营养活动或家庭聚会。现身、打气，成为现场的一份子。",
      } satisfies Localized,
      action: {
        label: { en: "Browse opportunities", zh: "瀏覽機會", cn: "浏览机会" } satisfies Localized,
        href: "#opportunities",
      },
    },
    corporate: {
      audience: { en: "Companies & CSR", zh: "企業與 CSR", cn: "企业与 CSR" } satisfies Localized,
      title: { en: "Bring your team", zh: "帶你的團隊同行", cn: "带你的团队同行" } satisfies Localized,
      description: {
        en: "Plan a meaningful corporate day built around shared activity and human connection.",
        zh: "規劃以共同活動與人相連為本的企業日。",
        cn: "规划以共同活动与人相连为本的企业日。",
      } satisfies Localized,
      action: {
        label: { en: "Explore partnerships", zh: "了解合作", cn: "了解合作" } satisfies Localized,
        href: "#corporate",
      },
    },
    give: {
      audience: { en: "Fundraise & give", zh: "籌款與捐助", cn: "筹款与捐助" } satisfies Localized,
      title: { en: "Keep programmes free", zh: "維持計劃免費", cn: "维持计划免费" } satisfies Localized,
      description: {
        ...
        cn: "你的捐助帮助 Love 21 维持体育、营养与家庭支援计划开放予社群。",
      } satisfies Localized,
      action: {
        label: { en: "Donate", zh: "捐助", cn: "捐助" } satisfies Localized,
        href: { en: "/donate/", zh: "/zh/donate-hk/", cn: "/cn/donate/" },
      },
    },
  },
  opportunities: {
    badge: { en: "Volunteer opportunities", zh: "義工機會", cn: "义工机会" } satisfies Localized,
    title: {
    ...
    calendarLink: {
      label: { en: "See full calendar", zh: "查看完整日曆", cn: "查看完整日历" } satisfies Localized,
      href: { en: "/events", zh: "/zh/events-hk/", cn: "/cn/events" },
    },
    signup: { en: "Sign up", zh: "報名", cn: "报名" } satisfies Localized,
    empty: {
      en: "No opportunities in this category right now — try another filter or the full calendar.",
      zh: "此分類暫時沒有機會 — 試試其他篩選或查看完整日曆。",
      cn: "此分类暂时没有机会 — 试试其他筛选或查看完整日历。",
    } satisfies Localized,
    previewNotice: {
      ...
      cn: "仅供预览 — 报名尚未上线。请通过「成为义工」或 HandsOn Hong Kong 登记兴趣。",
    } satisfies Localized,
  },
  corporate: {
    badge: { en: "Corporate partnerships", zh: "企業夥伴", cn: "企业伙伴" } satisfies Localized,
    title: {
    ...
    bookSession: {
      label: { en: "Book a session", zh: "預約時段", cn: "预约时段" } satisfies Localized,
    },
    talkTeam: {
      label: { en: "Talk to our team", zh: "聯絡我們的團隊", cn: "联系我们的团队" } satisfies Localized,
    ...
    bookPreviewNotice: {
      ...
      cn: "仅供预览 — 预约尚未上线。请联系团队查询。",
    } satisfies Localized,
    howItWorks: {
      eyebrow: { en: "How a corporate day works", zh: "企業日如何進行", cn: "企业日如何进行" } satisfies Localized,
      steps: [
        {
          title: { en: "Say hello", zh: "先打個招呼", cn: "先打个招呼" } satisfies Localized,
          copy: {
    ...
    quote: {
      body: {
        ...
        cn: "团队离开时谈论的是人，而不是一个计划。这是我们在香港最有温度的 CSR 一天。",
      } satisfies Localized,
      attribution: {
        en: "Laura · Nakama Global",
        zh: "Laura · Nakama Global",
        cn: "Laura · Nakama Global",
      } satisfies Localized,
      note: {
  ...
  bottomCta: {
    title: { en: "Not sure where to start?", zh: "不知道從何開始？", cn: "不知道从哪里开始？" } satisfies Localized,
    description: {
      ...
      cn: "告诉我们一点关于你的事，我们会协助你找到合适方向 — 义工、企业或捐助。",
    } satisfies Localized,
    volunteer: {
      label: { en: "Volunteer", zh: "做義工", cn: "做义工" } satisfies Localized,
      href: { en: "/our-volunteer/", zh: "/zh/our-volunteer-hk/", cn: "/cn/our-volunteer/" },
    },
    corporate: {
      label: { en: "Corporate enquiry", zh: "企業查詢", cn: "企业查询" } satisfies Localized,
      href: { en: "/contact-us/", zh: "/zh/contact-us-hk/", cn: "/cn/contact-us/" },
    },
  },
} as const;
